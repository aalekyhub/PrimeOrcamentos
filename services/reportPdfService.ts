        ...
        <div class="pdf-page-content">
            <div style="width:100%; background:#ffffff; font-family:Inter, Arial, sans-serif; color:#1e293b; padding:0;">
                    ...
                    <table style="width:100%; border-collapse:collapse;">
                        <tr>
                            <td colspan="3" style="padding:0 0 12px 0; vertical-align:top; border-bottom:1px solid #e2e8f0; margin-bottom:12px;">
                                ...
                                <p style="margin:0; font-size:14px; color:#0f172a; font-weight:900; text-transform:uppercase;">${escapeHtml(header.name || 'Não informado')}</p>
                            </td>
                        </tr>
                        <tr>
                ...
                <div style="margin-bottom: 20px;">
                    <table style="width:100%; border-collapse:collapse; table-layout:fixed;">
                        <tr>
                            <td style="width:${(header as any).annex_image ? '65%' : '100%'}; vertical-align:top; padding-right:${(header as any).annex_image ? '10px' : '0'};">
                            ...
                            <td style="width:35%; vertical-align:top;">
                                <div style="background:#f1f5f9; border-radius:6px; border:1px solid #e2e8f0; padding:6px; height: 145px; display: flex; flex-direction: column;">
                                    ...
                                    <div style="flex-grow: 1; display:flex; align-items:center; justify-content:center; overflow:hidden; background:white; border-radius:4px;">
                                        <img src="${(header as any).annex_image}" style="max-width:100%; max-height:120px; object-fit:contain;" />
                                    </div>
                                </div>
                            </td>
                            ` : ''}
