      ...
      <div class="a4-container">
               ...
               <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 24px; border-bottom: 2px solid #0f172a; padding-bottom: 16px;">
                   <div style="display: flex; gap: 24px; align-items: center;">
                       ...
                       <div>
                           ...
                           <p style="margin: 0; font-size: 9px; font-weight: bold; color: #2563eb; text-transform: uppercase; letter-spacing: 0.1em;">Solu├º├Áes em Gest├úo Profissional</p>
                   ...
                   <div style="text-align: right;">
                       ...
                       <p style="margin: 4px 0 0 0; font-size: 8px; font-weight: 600; color: #475569; text-transform: uppercase; letter-spacing: 0.1em; line-height: 1.4;">EMISS├âO: ${emissionDate} <br> VALIDADE: ${validityDate}</p>
                   </div>
               </div>
               ...
               <div style="display: flex; gap: 24px; margin-bottom: 24px;">
                   <div style="flex: 1; background: #f8fafc; border-radius: 12px; padding: 20px; border: 1px solid #e2e8f0;">
                       <span style="font-size: ${Math.max(10, (company.descriptionFontSize || 12))}px; font-weight: 600; color: #3b82f6; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; display: block;">Cliente / Destinat├írio</span>
                       <div style="font-size: 11px; font-weight: 700; color: #0f172a; text-transform: uppercase; line-height: 1.4;">${customer.name}</div>
                       <div style="font-size: 10px; color: #475569; font-weight: 500; margin-top: 4px;">${customer.document || 'CPF/CNPJ n├úo informado'}</div>
                   </div>
                   <div style="flex: 1; background: #f8fafc; border-radius: 12px; padding: 20px; border: 1px solid #e2e8f0;">
                       <span style="font-size: ${Math.max(10, (company.descriptionFontSize || 12))}px; font-weight: 600; color: #3b82f6; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; display: block;">Refer├¬ncia do Or├ºamento</span>
                       <div style="font-size: 11px; font-weight: 700; color: #0f172a; text-transform: uppercase; line-height: 1.4;">${budget.description || 'Proposta de Presta├º├úo de Servi├ºos'}</div>
                   </div>
               </div>
               ...
               ${budget.descriptionBlocks && budget.descriptionBlocks.length > 0 ? `
                <div style="margin-bottom: 40px;" class="print-description-content">
                  <div style="font-size: 10px; font-weight: 700; color: #475569; text-transform: uppercase; letter-spacing: 0.1em; padding-bottom: 8px; border-bottom: 1px solid #e2e8f0; margin-bottom: 16px;">DESCRI├ç├âO DOS SERVI├çOS</div>
      ...
      return '';
                     ...
                     <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="border-bottom: 2px solid #0f172a;">
                                <th style="padding-bottom: 12px; font-size: ${Math.max(7, itemFontBase - 2)}px; text-transform: uppercase; color: #475569; text-align: left; font-weight: 700; width: 60%;">Item / Descri├º├úo</th>
                                ...
                                <th style="padding-bottom: 12px; font-size: ${Math.max(7, itemFontBase - 2)}px; text-transform: uppercase; color: #475569; text-align: right; font-weight: 700; width: 15%;">Unit├írio</th>
               ...
               <div style="margin-bottom: 24px; break-inside: avoid;">
                   <div style="display: flex; gap: 24px;">
                       ...
                       <div style="flex: 1; background: #f8fafc; border-radius: 12px; padding: 20px; border: 1px solid #e2e8f0;">
                           <span style="font-size: 10px; font-weight: 600; color: #3b82f6; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; display: block;">Prazo de Entrega / Execu├º├úo</span>
               ...
               <div style="margin-bottom: 24px; break-inside: avoid;">
                   <div style="border: 1px solid #dbeafe; background: #eff6ff; border-radius: 16px; padding: 24px;">
                        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                            <div style="background: #2563eb; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 10px; font-weight: bold;">Ô£ô</div>
                            <span style="font-size: 14px; font-weight: bold; color: #1e40af; text-transform: uppercase; letter-spacing: 0.1em;">Termo de Aceite e Autoriza├º├úo Profissional</span>
                        </div>
                        <p style="margin: 0; font-size: ${Math.max(13, (company.descriptionFontSize || 14) - 1)}px; color: #1e3a8a; line-height: 1.6; text-align: justify; font-style: italic;">
                            "Este documento constitui uma proposta comercial formal. Ao assinar abaixo, o cliente declara estar ciente e de pleno acordo com os valores, prazos e especifica├º├Áes t├®cnicas descritas. Esta aceita├º├úo autoriza o in├¡cio imediato dos trabalhos sob as condi├º├Áes estabelecidas. A contratada reserva-se o direito de renegociar valores caso a aprova├º├úo ocorra ap├│s o prazo de validade de ${validityDays} dias. Eventuais altera├º├Áes de escopo solicitadas ap├│s o aceite estar├úo sujeitas a nova an├ílise de custos."
                        </p>
                   </div>
               </div>
