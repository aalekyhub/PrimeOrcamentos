            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                <div className="md:col-span-4">
                    ...
                    <input
                        ...
                        className="w-full p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-sm h-9 focus:ring-2 focus:ring-blue-100 outline-none text-slate-900 dark:text-slate-100"
                ...
                <div className="md:col-span-2">
                    ...
                    <select
                        ...
                        className="w-full p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-sm h-9 outline-none text-slate-900 dark:text-slate-100"
                    >
                ...
                <div className="md:col-span-2">
                    <button
                        ...
                        className="w-full bg-blue-600 text-white p-2 rounded hover:bg-blue-700 font-bold text-xs h-9 flex items-center justify-center gap-1 shadow-md"
                    >
