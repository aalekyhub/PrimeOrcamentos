...
export const EditableMaterialRow: React.FC<EditableMaterialRowProps> = ({
    material,
    index,
    isDragged,
    onDragStart,
    ...
    const [editName, setEditName] = useState(material.material_name);
    const [editUnit, setEditUnit] = useState(material.unit);
    const [editQty, setEditQty] = useState(material.quantity);
    const [editCost, setEditCost] = useState(material.unit_cost);

    const handleSave = () => {
        onUpdate({
            ...material,
            material_name: editName.toUpperCase(),
            ...
            {isEditing ? (
                ...
                <>
                    ...
                    <div className="flex gap-1">
                        ...
                        <button onClick={() => onDelete(material.id)} className="text-slate-300 hover:text-red-500 p-1">
                            <Trash2 size={14} />
                        </button>
                    </div>
                </>
