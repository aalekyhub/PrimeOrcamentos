...
import { ReportTheme } from '../../services/planningPdfService';
...
export const PlanningDocument = React.forwardRef<HTMLDivElement, PlanningDocumentProps>(
    ({ header, customers, services, materials, labor, indirects, taxes, calculations, company, theme }, ref) => {
        ...
        return (
            <div ref={ref} className="pdf-page print-description-content" style={{ fontFamily: 'Arial, Helvetica, sans-serif', color: '#1e293b' }}>
...
PlanningDocument.displayName = 'PlanningDocument';
