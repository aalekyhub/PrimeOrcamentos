    ...
    const generateFullReportHtml = () => {
        ...
        return `
            <div style="width: 100%; background: white; font-family: sans-serif;">
                ...
                <!-- INFO GRID -->
                <div style="display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 20px; background: #f8fafc; padding: 16px; border-radius: 6px; border-bottom: 1.5px solid #e2e8f0; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                ...
                <div style="display: flex; gap: 12px; margin-bottom: 25px;">
                    ...
                    <div style="flex: 1; background: #ecfdf5; border-bottom: 2px solid #10b981; border-radius: 6px; padding: 12px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                        ...
                        <span style="font-size: 16px; font-weight: 800; color: #064e3b; display: block; white-space: nowrap;">R$ ${totalMaterials.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                    </div>` : ''}
                    ${totalLabor > 0 ? `
                    ...
                    <div style="flex: 1; background: #eff6ff; border-bottom: 2px solid #3b82f6; border-radius: 6px; padding: 12px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {plans.map(plan => (
                            <div key={plan.id}
                                ...
                                className="bg-white shadow-xl w-full max-w-[210mm] p-[5mm] overflow-x-hidden rounded-sm border border-slate-200 dark:border-slate-800 hover:border-blue-400 transition-all group relative">
