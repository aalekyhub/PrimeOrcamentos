        ...
        * { box-sizing: border-box; }
        ...
        @media print { 
          ...
          * { box-shadow: none !important; } 
          ...
          .ql-editor-print ul { list-style-type: none !important; padding-left: 0 !important; margin: 12px 0 !important; }
      ...
      <div class="a4-container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; padding-bottom: 15px; border-bottom: 2px solid #e2e8f0;">
          ...
          <div style="background:#f8fafc; padding: 18px; border-radius: 12px; border: 1px solid #dbeafe;">
            ...
            <p style="font-size:11px; font-weight:600; color:#64748b; margin:1mm 0 0 0;">CNPJ: ${customer.document || 'N/A'}</p>
        ...
        <div style="margin-bottom: 5mm; page-break-inside: avoid; break-inside: avoid-page;">
          ...
          <p style="font-size:13px; color:#475569; line-height:1.6; text-align:justify; margin:10px 0 0 0;">1.3. No se caracteriza, em hipótese alguma, cessão ou locação de mão de obra.</p>
        </div>
