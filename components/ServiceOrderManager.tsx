...
import {
    ...
    UserPlus, Wrench, Eraser, FileText
} from 'lucide-react';
                        ...
                        <div className="flex-1 flex overflow-hidden">
                            <div className="flex-1 overflow-y-auto p-8 space-y-6 bg-[#f8fafc] no-scrollbar">
                                ...
                                <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
                                    ...
                                    <div><label className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Laudo Técnico / Diagnóstico</label><textarea className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs font-medium text-slate-700 outline-none h-24 focus:ring-2 focus:ring-blue-500" placeholder="Descreva o problema ou serviço realizado..." value={diagnosis} onChange={e => setDiagnosis(e.target.value)} /></div>
                                </div>
