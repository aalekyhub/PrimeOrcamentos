    ...
    const handlePrintOS = (order: ServiceOrder, mode: 'print' | 'pdf' = 'print') => {
      ...
      <head>
        ...
        <style>
           ...
           @media print { body { background: white !important; margin: 0 !important; } .a4-container { box-shadow: none !important; border: none !important; min-height: auto; position: relative; } .no-screen { display: block !important; } .no-print { display: none !important; } .print-footer { position: fixed; bottom: 0; left: 0; right: 0; padding-bottom: 5mm; text-align: center; font-size: 8px; font-weight: bold; color: #94a3b8; text-transform: uppercase; } .avoid-break { break-inside: avoid !important; page-break-inside: avoid !important; display: table !important; width: 100% !important; } }
        </style>
      </head>
            ...
            <div class="a4-container">
               ...
               <div class="mb-12">
                   ...
                   <div class="info-box bg-slate-50 border border-slate-100">
                       <p class="text-[10px] text-slate-600 leading-relaxed italic">${order.serviceDescription || 'Nenhuma observação técnica registrada.'}</p>
                   </div>
               </div>
      ...
      <div id="contract-content">
          <div class="a4-container">
            <div class="flex justify-between items-start mb-8">
                ...
                <div class="text-right">
                    <table style="display: inline-table; background: #2563eb; border-radius: 4px; border-collapse: separate; margin-bottom: 4px;">
                        <tr><td style="padding: 4px 12px; font-size: 8px; font-weight: 900; color: white; text-transform: uppercase; vertical-align: middle; letter-spacing: 0.1em;">CONTRATO</td></tr>
                    </table>
