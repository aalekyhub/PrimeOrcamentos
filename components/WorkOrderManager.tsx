      ...
      <div id="contract-content">
          <div class="a4-container">
            <div class="flex justify-between items-start mb-8">
                ...
                <div class="text-right">
                    <div class="bg-blue-600 text-white rounded text-[8px] font-black uppercase tracking-widest mb-1 text-center" style="height: 20px; line-height: 20px; padding: 0 15px; display: inline-block;">CONTRATO</div>
