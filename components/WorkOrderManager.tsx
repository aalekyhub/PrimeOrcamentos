      ...
      <div id="contract-content">
          <div class="a4-container">
            <div class="flex justify-between items-start mb-8">
                ...
                <div class="text-right">
                    <div class="bg-blue-600 text-white px-4 py-1.5 rounded text-[8px] font-black uppercase tracking-widest mb-1 inline-block text-center leading-none">CONTRATO</div>
