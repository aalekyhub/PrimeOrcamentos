...
const WorksManager: React.FC<Props> = ({ customers, embeddedPlanId, onBack }) => {
    ...
    const generateFullReportHtml = () => {
        ...
        const formatCurrency = (val: number | undefined | null) => `<span style="white-space: nowrap;">${(val || 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL', minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>`;
                           ...
                           <div class="a4-container" style="padding-bottom: 10px !important; border-bottom: 2px solid #e2e8f0; margin-bottom: 10px;">
                            ...
                            <div class="a4-container">
                                ...
                                <div style="display: flex; flex-wrap: wrap; gap: 24px; margin-bottom: 32px; background: #f1f5f9; padding: 24px; border-radius: 8px; border-bottom: 2px solid #cbd5e1; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                                    ...
                                    <div style="flex: 1; min-width: 200px;">
                                        <p style="margin: 0 0 6px 0; font-size: 10px; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">Status da Obra</p>
                                        <p style="margin: 0; font-size: 14px; color: #0f172a; font-weight: 700;">${currentWork.status}</p>
                                    </div>
                                    <div style="width: 100%;">
                                        <p style="margin: 0 0 6px 0; font-size: 10px; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">Endereço da Obra</p>
                                        <p style="margin: 0; font-size: 14px; color: #0f172a; font-weight: 700;">${currentWork.address || 'Não Informado'}</p>
                                    </div>
                                </div>
                                    ...
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="padding: 12px 0; text-align: center; font-size: 10px; color: #64748b; width: 60px; border-bottom: 2px solid #e2e8f0;">DIAS</th>
                                                <th style="padding: 12px 0; text-align: right; font-size: 10px; color: #64748b; width: 100px; border-bottom: 2px solid #e2e8f0; white-space: nowrap;">CUSTO UNIT</th>
                                                <th style="padding: 12px 0; text-align: right; font-size: 10px; color: #64748b; width: 100px; border-bottom: 2px solid #e2e8f0; white-space: nowrap;">CUSTO TOTAL</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ${labor.map(l => `
                                                <tr>
                                                    ...
                                                    <td style="padding: 12px 0; font-size: 11px; text-align: right; color: #64748b; border-bottom: 1px solid #f1f5f9; white-space: nowrap;">R$ ${l.unit_cost.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                                    ...
                                    <div className="animate-in fade-in slide-in-from-left-4 duration-500">
                                        ...
                                        {materials.length > 0 ? (
                                            ...
                                            <div className="text-center py-20 bg-slate-50 dark:bg-slate-900/50 rounded-[2rem] border-2 border-dashed border-slate-200 dark:border-slate-800">
                                                ...
                                                <p className="text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest text-[10px]">Nenhum material lançado</p>
                                                <p className="text-slate-300 dark:text-slate-600 text-[10px] mt-1">Utilize o formulário acima para adicionar materiais à obra.</p>
                                            </div>
                                        )}
                                    </div>
                                )}
