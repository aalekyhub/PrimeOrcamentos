            ...
            <div style="width: 100%; background: white; font-family: sans-serif;">
                ...
                <div style="display: flex; gap: 16px; margin-bottom: 20px;">
                    ...
                    <div style="flex: 1; background: #ecfdf5; border-bottom: 3px solid #10b981; border-radius: 8px; padding: 16px; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                        ...
                        <span style="font-size: 18px; font-weight: 800; color: #064e3b; display: block; white-space: nowrap;">R$ ${totalMaterial.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                    </div>` : ''}
                    ${totalLabor > 0 ? `
                ...
                <div style="margin-bottom: 32px; background: #064e3b; color: white; padding: 16px 20px; border-radius: 8px; display: flex; justify-content: space-between; align-items: center;">
                    <p style="font-size: 10px; font-weight: 800; text-transform: uppercase; margin: 0; letter-spacing: 0.1em; color: #a7f3d0;">CUSTO TOTAL EXECUTADO</p>
                                            ...
                                            {indirects.map((i) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="text-right flex items-center gap-4">
                                                        ...
                                                        <div className="flex gap-1 border-l pl-3 border-slate-100 dark:border-slate-800">
                                                            <button onClick={() => handleDeleteIndirect(i.id)} className="p-1.5 text-slate-300 hover:text-red-500 transition-colors"><Trash2 size={16} /></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ))}
